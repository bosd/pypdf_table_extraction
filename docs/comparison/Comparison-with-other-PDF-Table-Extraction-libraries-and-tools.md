...
<table>
  ...
  <tr>
    ...
    <td>Camelot</td>
    <td>Tabula doesn't output all the header text. Camelot gets all the headers in the correct cells, albeit in reverse order in some cases.</td>
  </tr>
  <tr>
    <td>2.</td>
  ...
  <tr>
    ...
    <td>Camelot</td>
    <td>Tabula shifts some of the data points towards the left. Camelot gets the table as is.</td>
  </tr>
  <tr>
    <td>4.</td>
    ...
    <td>Camelot</td>
    <td>Tabula moves some headers on the top-right to the left. Camelot gets them in the correct cells.</td>
  </tr>
  <tr>
    <td>5.</td>
    ...
    <td>Camelot</td>
    <td>Tabula shifts some of the data points towards the left. Camelot gets the table as is. (For ex: The number 1728)</td>
  </tr>
  <tr>
    <td>6.</td>
    ...
    <td>Camelot</td>
    <td>Tabula doesn't give an output. Camelot is able to get all text out while preserving the table structure, which is usable by cleaning after some patter matching.</td>
  </tr>
  <tr>
    <td>7.</td>
    ...
    <td>Camelot</td>
    <td>Tabula output is unusable, Camelot gets the table out as is.</td>
  </tr>
  <tr>
    <td>8.</td>
    ...
    <td>Camelot</td>
    <td>Tabula shifts some of the data points towards the left. Camelot gets the table as is. Check out the totals near the bottom-right.</td>
  </tr>
  <tr>
    <td>9.</td>
    ...
    <td>Camelot</td>
    <td>Tabula output is unusable, Camelot gets the tables out as they are.</td>
  </tr>
  <tr>
    <td>10.</td>
...
<table>
  ...
  <tr>
    ...
    <td>Tabula</td>
    <td>Camelot detects two tables, and even though the structure is correct, duplicate strings are found in the same cells. Bug filed. <a href="https://github.com/socialcopsdev/camelot/issues/103">#103</a>.</td>
  </tr>
  <tr>
    <td>3.</td>
    ...
    <td>Camelot</td>
    <td>Tabula merges the last two columns into one, Camelot gets them correctly.</td>
  </tr>
  <tr>
    <td>4.</td>
    ...
    <td>Camelot</td>
    <td>Tabula merges all the columns. Camelot assigns the data points to the correct cells.</td>
  </tr>
  <tr>
    <td>5.</td>
  ...
  <tr>
    ...
    <td>Camelot</td>
    <td>Tabula merges some columns. Camelot uses its "-split" feature along with column separators to cut the text strings at those coordinates and put them in the correct cells.</td>
  </tr>
  <tr>
    <td>7.</td>
  ...
  <tr>
    ...
    <td>Camelot</td>
    <td>Tabula merges some columns, Camelot gets them correctly.</td>
  </tr>
  <tr>
    <td>9.</td>
  ...
  <tr>
    ...
    <td>Camelot</td>
    <td>Tabula merges the superscript with the number, which doesn't matter in this case due to the decimal point but can change the number by 10x without the point. Camelot uses a configuration parameter to delimit the superscripts with <pre>&lt;s&gt;&lt;/s&gt;</pre> tags, so that they can be handled during cleaning.</td>
  </tr>
</table>

# [pdfplumber](https://github.com/jsvine/pdfplumber)

5 PDFs of each type were used from the table above, for which Camelot required no extra configuration. Tables from the selected PDFs were parsed using [this script](https://gist.github.com/vinayak-mehta/8a3bf37350b241b966483d202a5109b9) (which uses pdfplumber) and Camelot's command-line-interface.
...
Again, 5 PDFs of each type were used from the table above, for which Camelot required no extra configuration. Tables from the selected PDFs were parsed using [this script](https://gist.github.com/vinayak-mehta/9e134715793c70845d0c84fce264e0ec) (which uses pdftables) and Camelot's command-line-interface.
...
5 PDFs of each type were used from the table above, for which Camelot required no extra configuration. Tables from the selected PDFs were parsed using [this script](https://gist.github.com/vinayak-mehta/b042ce545779cf7565e6530036e7a9de) (which uses pdf-table-extract) and Camelot's command-line-interface.
...
<table>
  ...
  <tr>
    ...
    <td><a href="https://github.com/socialcopsdev/camelot/blob/master/docs/benchmark/lattice/agstat/agstat-data-camelot-page-1-table-1.csv">csv</a></td>
    <td>Both</td>
    <td>Camelot puts vertical headers in reverse order. Bug filed. [#105]</td>
  </tr>
  <tr>
    <td>2.</td>
    <td><a href="https://github.com/socialcopsdev/camelot/blob/master/docs/benchmark/lattice/column_span_1/column_span_1.pdf">column_span_1.pdf</a></td>
